<%@ Page Title="Shop" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Shop.aspx.cs" Inherits="EcommerceShop.Shop" %>
            ...
            <div class="col-lg-9 col-md-12">
                <div class="row pb-3">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            ...
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 id="labProductname" name="labProductname" class="text-truncate mb-3">Đầm Đuôi Cá Dáng Ngắn</h6>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="img/7.png" style="width: 500px; height: 565px" alt="">
                            </div>
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3">Quần Jeans Xanh Dương Đậm</h6>
                                <div class="d-flex justify-content-center">
                                    <h6>327.000đ</h6>
                                    <h6 class="text-muted ml-2"><del>1.090.000đ</del></h6>
                                </div>
