...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 pb-5">
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    <div class="input-group quantity mr-3" style="width: 130px; top: 0px; left: 0px;">
                    ...
                    <asp:LinkButton ID="LinkButton1"  runat="server" OnClientClick="return confirm('Bạn muốn lưu sản phẩm này không?')" OnClick="LinkButton1_Click" > Add To Cart</asp:LinkButton>
      ...
      <%--<asp:LinkButton id="LinkButton1"  OnClientClick="return confirm('Bạn muốn lưu sản phẩm này không?')" runat="server"  OnClick="btnAddCart_Click"> Add To Cart</asp:LinkButton>--%>
